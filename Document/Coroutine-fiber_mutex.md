...
1. [코루틴 동기화 소개](#코루틴-동기화-소개)
2. [`fiber_mutex`란 무엇인가?](#fiber_mutex란-무엇인가)
3. [`fiber_mutex`의 내부 동작 방식](#fiber_mutex의-내부-동작-방식)
4. [전통적인 뮤텍스와 `fiber_mutex`의 차이점](#전통적인-뮤텍스와-fiber_mutex의-차이점)
5. [왜 코루틴 환경에서 `fiber_mutex`를 사용하는가?](#왜-코루틴-환경에서-fiber_mutex를-사용하는가)
6. [코드 예시: `fiber_mutex`를 활용한 코루틴 동기화](#코드-예시-fiber_mutex를-활용한-코루틴-동기화)
7. [중요 고려사항](#중요-고려사항)
8. [결론](#결론)
